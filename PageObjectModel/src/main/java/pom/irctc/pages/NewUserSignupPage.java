...
public class NewUserSignupPage extends GenericWrappers{
	...
	public NewUserSignupPage selectSecurityQuestion(String data) {
	...
	public NewUserSignupPage selectOccupation(String data) {
...
public NewUserSignupPage enterStreet(String data) {
	...
	public NewUserSignupPage clickOnAddress() {
