...
public class TC005BookHotelGstValidate {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        gst_select.selectByVisibleText("Yes");
		
		Thread.sleep(2000);
		
		driver.findElementByName("companyName").sendKeys("GM Motors");
		
		driver.findElementByName("companyAddress").sendKeys("Tamilnadu, India");
		...
		String gstNoErr = driver.findElementByXPath("/html/body/app-root/app-fulllayout/app-paxdetail/div[2]/div/div/div[3]/div/div/div/form/div[9]/div/span").getText();
		
		if(gstNoErr.contains("gstNumber is required."))
		{
